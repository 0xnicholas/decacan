...
use crate::synthesis::events::{ContinuationState, SynthesisInvocationEvent};
use crate::synthesis::model::OutputCandidate;
use crate::synthesis::planner::{LocalPlan, PlannerInput, SynthesisPlanStep};
...
pub struct InvocationState {
    ...
    pub events: Vec<SynthesisInvocationEvent>,
}
...
impl InvocationState {
    pub fn new(context: &InvocationContext) -> Self {
        ...
        Self {
            ...
            events: vec![SynthesisInvocationEvent::LocalPlanPrepared { step_count }],
        }
    }

    pub fn current_step(&self) -> Option<&SynthesisPlanStep> {
