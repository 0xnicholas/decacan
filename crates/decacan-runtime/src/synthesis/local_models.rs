...
pub struct SummarySynthesisModel;

impl SynthesisModel for SummarySynthesisModel {
    ...
    fn produce_output_candidate(
        ...
        Ok(OutputCandidate {
            artifact_id: "synthesis-output-summary".to_owned(),
...
#[derive(Debug, Clone, Copy)]
pub struct DiscoverySynthesisModel;

impl SynthesisModel for DiscoverySynthesisModel {
    type Error = core::convert::Infallible;
    ...
    fn produce_output_candidate(
        ...
        Ok(OutputCandidate {
            artifact_id: "synthesis-output-discovery".to_owned(),
